...
\end{frame}
\begin{frame}{Ý tưởng thuật toán HyperLogLog}
\subsection{Ý tưởng thuật toán HyperLogLog}
\end{frame}
\begin{frame}{Nếu như bạn có một ngày rảnh dỗi!!}

Giả sử vào một ngày đẹp trời bạn có thời gian rảnh ngồi tung đồng xu và ghi lại số lượng các mặt ngửa liên tiếp nhau lớn nhất. 
\begin{itemize}
\item Nếu số đó là 3 bạn đã dành không nhiều thời gian cho việc tung đồng xu này
\item Nếu số đó là 10 bạn đã dành tương đối nhiều thời gian cho việc tung đồng xu
...
\item Giả sử bạn là một người rất may mắn sau 11 lần tung bạn đạt được 10 mặt ngửa sau đó bạn dừng lại ngay\\
=> Tôi sẽ có một dự doán rất tệ về số lượng thời gian bạn đã bỏ ra
\item Cải tiến:
\begin{itemize}
\item Tung 10 đồng xu và ghi lại 10 kết quả lớn nhất với mỗi đồng
\item Tính trung bình của 10 kết quả thu được
\end{itemize}
\end{itemize}
\end{frame}
\begin{frame}{Ý tưởng thuật toán HyperLoglog}
\begin{itemize}
\item Hàm băm H được sử dụng: với mỗi giá trị x trong datastream ta luôn chỉ băm được ra một giá trị. Vì vậy nếu ta dùng một mảng lưu trữ để đánh dấu xem gía trị băm nào đã được băm tới rồi băm hết mutilset ta hoàn toàn có thể biết được số lượng phần tử khác nhau trong multilset. => vấn đề: ta không thể sử dụng nhiều bộ nhớ như vậy
\item Sử dụng bài toán "rảnh dỗi": Ta sẽ lấy p bit đầu của giá trị băm làm index từ đố ta đã gián tiếp mô tả  $2^p$ đồng xu ta cần một mảng M để lưu lại giá lớn nhất các số 0 liên tiếp (mặt ngửa) tính từ giá trị đầu tiên(với điều kiện hàm tạo ra dãy bit một cách tương đối độc lập(giả ngẫu nhiên)) 
\end{itemize}
\end{frame}
